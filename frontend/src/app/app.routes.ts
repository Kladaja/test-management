...
export const routes: Routes = [
    ...
    { path: 'project-management', loadComponent: () => import('./project-management/project-management.component').then((c) => c.ProjectManagementComponent), canActivate: [authGuard] },
